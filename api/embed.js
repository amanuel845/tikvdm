    ...
    return {
      ...
      data: {
        video: {
          ...
          covers:          itemInfos.covers ?? [],
          coversOrigin:    itemInfos.coversOrigin ?? [],
          coversDynamic:   itemInfos.coversDynamic ?? [],
        ...
        author: {
          ...
          covers:       authorInfos.covers ?? [],
          coversMedium: authorInfos.coversMedium ?? [],
          coversLarger: authorInfos.coversLarger ?? [],
        },
        source: targetUrl,
...
/* ============================================================
   Concurrency pool — runs `tasks` (array of async fns) with a
   limit, preserving input order in the result array.
   ============================================================ */
  ...
  async function worker() {
    while (true) {
      ...
      try {
        ...
        // scrapeVideo shouldn't throw, but be safe.
